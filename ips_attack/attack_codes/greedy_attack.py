...
def greedy_attack(x, y, syndict, BBM):
    ...
    # Success or Fail
        ...
        query_budget = get_query_budget(x_, syndict, baseline='textfooler')#zhz

        x_att, attack_logs = greedy_attack_(x_, syndict, BBM, query_budget)
...
def greedy_attack_(x, syndict, BBM, query_budget): #zhz query_budget
    ...
    for ind in ind_order:
        ...
        for new_word in syndict[cur_word]:
            ...
            #zhz
            if BBM.num_queries >= query_budget:
