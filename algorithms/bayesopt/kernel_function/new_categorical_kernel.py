    ...
    def forward(
        ...
        **kwargs
        ...
        if key == 0: # Memory efficient implementation
            dists = BinaryGradientFunction.apply(self.lengthscale.unsqueeze(-2), x1, x2)  # kernel / beta_i
        elif key == 1:
...
if __name__=='__main__':
    ...
    m = CategoricalKernel2(ard_num_dims=L, lengthscale_prior=lengthscale_prior, active_dims=L, lengthscale_constraint=GreaterThan(1e-06)).cuda()
