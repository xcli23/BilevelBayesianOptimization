...
class ModelArgs:
    ...
    def _create_model_from_args(cls, args):
        ...
        if args.model_from_file:
            ...
            # model.save_pretrained(f"{home_directory}/DiscreteBlockBayesAttack/pretrains/bert-base-uncased-ag-news")
            # tokenizer.save_pretrained(f"{home_directory}/DiscreteBlockBayesAttack/pretrains/bert-base-uncased-ag-news")
