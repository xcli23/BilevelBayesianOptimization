...
# Same with original attack recipe.
class TextFoolerJin2019Premise(AttackRecipe):
    @staticmethod
    def build(model_wrapper, product=False):
        transformation = WordSwapEmbedding(max_candidates=50)
        stopwords = set(
...
class TextFoolerJin2019Hypothesis(AttackRecipe):
    @staticmethod
    def build(model_wrapper, product=False):
        transformation = WordSwapEmbedding(max_candidates=50)
        stopwords = set(
...
class TextFoolerJin2019HowNet(AttackRecipe):
    """Jin, D., Jin, Z., Zhou, J.T., & Szolovits, P. (2019).
...
class TextFoolerJin2019WordNet(AttackRecipe):
    """ Alex """
