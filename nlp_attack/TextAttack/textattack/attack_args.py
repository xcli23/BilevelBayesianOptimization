...
ATTACK_RECIPE_NAMES = {
    ...
    "textfooler-wordnet": "textattack.attack_recipes.TextFoolerJin2019WordNet",
    ...
    "pso-wordnet": "textattack.attack_recipes.PSOZang2020Wordnet",
...
class AttackArgs:
    ...
    def _add_parser_args(cls, parser):
        ...
        parser.add_argument(
            ...
            required=False,
            default='hamming',
            help="-separated list of kernel functions to use",
        )
        parser.add_argument(
            "--sidx",
            type=int,
        ...
        parser.add_argument(
            ...
            type=int,
            required=False,
            default=default_obj.max_iter,
            help="max for weight bayes optimization",
        )
        parser.add_argument(
            "--threshold",
            type=float,
            required=False,
            default=default_obj.threshold,
            help="optimization threshold for true label ",
        )
