...
HUGGINGFACE_MODELS = {
    ...
    "bert-base-uncased-ag-news": f"{home_directory}/DiscreteBlockBayesAttack/pretrains/bert-base-uncased-ag-news",  
    ...
    "bert-base-uncased-mr": f"{home_directory}/DiscreteBlockBayesAttack/pretrains/bert-base-uncased-rotten-tomatoes",
    ...
    "xlnet-base-cased-mr": f"{home_directory}/DiscreteBlockBayesAttack/pretrains/xlnet-base-cased-rotten-tomatoes",
...
class ModelArgs:
    ...
    def _create_model_from_args(cls, args):
        ...
        if args.model_from_file:
            ...
            model.save_pretrained(f"{home_directory}/DiscreteBlockBayesAttack/pretrains/xlnet-base-cased-rotten-tomatoes")
            tokenizer.save_pretrained(f"{home_directory}/DiscreteBlockBayesAttack/pretrains/xlnet-base-cased-rotten-tomatoes")
            print("model saved success")

            # model_path = f"{home_directory}/DiscreteBlockBayesAttack/pretrains/xlnet-base-cased-rotten-tomatoes"
            ...
            print("load local pretrained model success")
